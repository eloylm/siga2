<?php
	 ...
	 * list a collection of UsuariosAnalisis objects.  It includes
	 * functionality to perform pagination and sorting on columns.
	 *
	 * To take advantage of some (or all) of these control objects, you
	 * must create a new QPanel which extends this UsuariosAnalisisListPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	class UsuariosAnalisisListPanel extends QPanel {
		// Local instance of the Meta DataGrid to list UsuariosAnalisises
		public $dtgUsuariosAnalisises;
		...
		public function __construct($objParentObject, $strSetEditPanelMethod, $strCloseEditPanelMethod, $strControlId = null) {
			...
			// Setup the Template
			$this->Template = 'UsuariosAnalisisListPanel.tpl.php';
			...
			$this->dtgUsuariosAnalisises->ItemsPerPage = 8;
			...
			$this->dtgUsuariosAnalisises->MetaAddEditProxyColumn($this->pxyEdit, 'Edit', 'Edit');
			...
			$this->btnCreateNew->Text = QApplication::Translate('Create a New') . ' ' . QApplication::Translate('UsuariosAnalisis');
			$this->btnCreateNew->AddAction(new QClickEvent(), new QAjaxControlAction($this, 'btnCreateNew_Click'));
		}

		public function pxyEdit_Click($strFormId, $strControlId, $strParameter) {
			$strParameterArray = explode(',', $strParameter);
			$objEditPanel = new UsuariosAnalisisEditPanel($this, $this->strCloseEditPanelMethod, $strParameterArray[0]);
		...
		public function btnCreateNew_Click($strFormId, $strControlId, $strParameter) {
			$objEditPanel = new UsuariosAnalisisEditPanel($this, $this->strCloseEditPanelMethod, null);
			$strMethodName = $this->strSetEditPanelMethod;
			$this->objForm->$strMethodName($objEditPanel);
		}
	}
