...
//				}
        ...
        //Agregado para el datagrid filter
       public function SetFilteredDataGridColumnFilter(QFilteredDataGridColumn $col) {

        switch($this->strType) {
          case QType::Boolean:
            //List of true / false / any $col->FilterType = QFilterType::ListFilter; $col->FilterAddListItem("True", QQ::Equal($this, true)); $col->FilterAddListItem("False", QQ::Equal($this, false)); $col->FilterAddListItem("Set", QQ::IsNotNull($this)); $col->FilterAddListItem("Unset", QQ::IsNull($this)); break;
          case QType::String:         case QType::DateTime:
            //LIKE $col->FilterType = QFilterType::TextFilter; $col->FilterPrefix = '%'; $col->FilterPostfix = '%'; $col->Filter = QQ::Like($this, null); break;
          case QType::Float: case QType::Integer:
            //EQUAL $col->FilterType = QFilterType::TextFilter; $col->Filter = QQ::Equal($this, null); break;
          case QType::Object: case QType::Resource:
            //this node points to a class, there's no way to know what to filter on $col->FilterType = QFilterType::None; $col->ClearFilter(); break;
        }
...
//Clase creada para el ilike de postregres
       class QQConditionILike extends QQConditionComparison {
		public function __construct(QQNode $objQueryNode, $strValue) {
			$this->objQueryNode = $objQueryNode;
			if (!$objQueryNode->_ParentNode)
				throw new QInvalidCastException('Unable to cast "' . $objQueryNode->_Name . '" table to Column-based QQNode', 3);
	...
	class QQ {
		...
		static public function Like(QQNode $objQueryNode, $strValue) {
			return new QQConditionLike($objQueryNode, $strValue);
                ...
                //Agregada por Eloy Y Jose
                static public function ILike(QQNode $objQueryNode, $strValue) {
			return new QQConditionILike($objQueryNode, $strValue);
		}
		...
		static public function _(QQNode $objQueryNode, $strSymbol, $mixValue, $mixValueTwo = null) {
			try {
				switch(strtolower(trim($strSymbol))) {
                    ...
                    case 'ilike': return QQ::ILike($objQueryNode, $mixValue);
