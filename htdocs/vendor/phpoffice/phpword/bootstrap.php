...
#$vendorDirPath = '/var/www/html/siga2/htdocs/vendor';
#error_log($vendorDirPath.'/autoload.php');
if (file_exists('/var/www/html/siga2/htdocs/vendor/autoload.php')) {
    require '/var/www/html/siga2/htdocs/vendor/autoload.php';
} else {
    throw new Exception(
        sprintf(
